...
>
> CADMIES was previously known as Project Hieros and hosted at
> `Hieros-CADMIES/CADMIES`. The project is now **Project Hierion**
> at `Project-Hierion/Hierion-CADMIES`. Some examples below may
> reference the old name for historical accuracy. All old GitHub
> URLs redirect automatically.
...
python tools/import_from_github.py --url https://github.com/Project-Hierion/Hierion-CADMIES/releases/download/v0.2.0-reader-capability/full_mycelium_v0.2.0.car
...
python tools/import_from_github.py --url https://github.com/Project-Hierion/Hierion-CADMIES/releases/download/v0.3.0-reader-fixes/full_mycelium_v0.3.0.car
